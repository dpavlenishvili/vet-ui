import { ChangeDetectionStrategy, Component, DestroyRef, type OnInit, signal } from '@angular/core';
import { UserOverviewComponent } from './user-overview/user-overview.component';
import { AuthService, type UserReq, type UserRes, UsersService } from '@vet/backend';
...
@Component({
  ...
  standalone: true,
  imports: [NgClass, UserOverviewComponent, UserPasswordChangeComponent, SVGIconModule, TranslocoPipe, ToastModule],
    ...
    return new FormGroup({
      mandatoryFields: new FormGroup({
        ...
        birth_date: new FormControl(
          user?.data?.birthDate ? this.formatDatePipe.transform(user.data.birthDate, { format: 'YYYY-MM-DD' }) : '',
        ),
      }),
