...
export class AuthService {
   ...
   * @summary Get user organisation info
   * @request GET:/auth/me/organisation/{code} */

  getUserOrganisation = (code: string, options: HttpRequestOptions = {}) => {
    return this.httpClient.get<OrganisationRes>(`${this.baseUrl}/auth/me/organisation/${code}`, options);
  };
  /**
   * No description * * @tags Auth
   * @name LogoutUser
