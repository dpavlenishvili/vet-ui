...
export class PartnerService {
  ...
  /**
   * @description Returns list of partners * * @tags Partner
   * @name Partners
   * @summary List of partners
   * @request GET:/partners */

  partners = (options: HttpRequestOptions = {}) => {
    return this.httpClient.get<PartnerRes>(`${this.baseUrl}/partners`, options);
  };
}
