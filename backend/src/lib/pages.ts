...
export class PagesService {
   ...
   */
  collectionsItems = (id: number) =>
    this.httpClient.get<CollectionItemsRes>(`${this.baseUrl}/collection/${id}`);
  ...
  getSingleCollectionItem = (collectionItemId: number) =>
    this.httpClient.get<CollectionItem>(
      `${this.baseUrl}/collection-item/${collectionItemId}`
    );
}
