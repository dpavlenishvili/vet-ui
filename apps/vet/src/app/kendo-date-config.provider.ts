...
const TRANSLATIONS: Record<string, TranslationSet> = {
  ka: {
    ...
    'kendo.datetimepicker.dateTab': 'თარიღი',
    'kendo.datetimepicker.timeTab': 'დრო',
    'kendo.datepicker.dateTab': 'თარიღი',
    'kendo.datepicker.timeTab': 'დრო',
    'kendo.datetimepicker.accept': 'დადასტურება',
    'kendo.datepicker.accept': 'დადასტურება',
    'kendo.datetimepicker.cancel': 'გაუქმება',
    'kendo.datepicker.cancel': 'გაუქმება',
  },
  en: {
