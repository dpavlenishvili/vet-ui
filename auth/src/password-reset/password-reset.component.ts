...
import { FormFieldComponent, FormFieldModule, TextBoxComponent } from '@progress/kendo-angular-inputs';
...
@Component({
    ...
    standalone: true,
    imports: [CommonModule, ButtonComponent, LabelComponent, ReactiveFormsModule, TextBoxComponent, TranslocoPipe, ToastModule, FormFieldModule],
