...
} from '../registration-phone-verification/registration-phone-verification.component';
...
@Component({
    ...
    standalone: true,
    imports: [CommonModule, ToastModule, LabelComponent, TextBoxComponent, TranslocoPipe, ReactiveFormsModule, RegistrationPhoneVerificationComponent, ButtonComponent],
...
export class RegistrationPhoneComponent implements OnInit {
    ...
    constructor(
        ...
        effect(() => {
            ...
            form.controls.phoneNumber.valueChanges.pipe(
    ...
    ngOnInit() {
        this.verificationCodeReloader.reloadable(() => {
            const form = this.form();
