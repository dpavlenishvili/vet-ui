...
import { minusCircled } from './minus-circled';
...
// Namespace export for convenience (commonly used as 'vetIcons.iconName')
// This exports ALL icons from both ./icons.ts and individually imported icons
export const vetIcons = {
  // Icons from ./icons.ts file
  eyeSlash,
  document,
  lookUp,
  confirmed,
