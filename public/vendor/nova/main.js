(self.webpackChunklaravel_nova = self.webpackChunklaravel_nova || []).push([
    [179],
    {
        2897: (a, r, l) => {
            function e(a, r) {
            ...
            function o(a) {
                for (var r = 1; r < arguments.length; r++) {
                    ...
                    r % 2
                        ? e(Object(l), !0).forEach(function (r) {
                              t(a, r, l[r]);
                          })
            ...
            function t(a, r, l) {
                return (
                    r in a
                        ? Object.defineProperty(a, r, { value: l, enumerable: !0, configurable: !0, writable: !0 })
                        : (a[r] = l),
                    a
                );
            }
        ...
        3098: (a, r, l) => {
            ...
            it('generates Tailwind colors', () => {
                expect((0, e.generateTailwindColors)()).toEqual(
            ...
            describe.each(Object.keys(o))('It does not generate the deprecated Tailwind colors', (a) => {
                it(`does not generate "${a}" colors`, () => {
                    expect((0, e.generateTailwindColors)()).toEqual(expect.not.objectContaining({ [a]: o[a] }));
                });
            }),
                it('generates root CSS variables', () => {
                    expect((0, e.generateRootCSSVars)()).toEqual(
                        expect.objectContaining({
